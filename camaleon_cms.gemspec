...
Gem::Specification.new do |s|
  ...
  s.summary     = "Camaleon is a CMS for Ruby on Rails as an alternative to Wordpress.this is a perdonal re build"
  s.description = "Camaleon CMS is a dynamic and advanced content management system based on Ruby on Rails as an alternative to Wordpress. this is a perdonal re build "
  s.license     = "MIT"
